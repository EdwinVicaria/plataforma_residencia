        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('roles.show', $role->id) }}" class="p-2 bg-blue-300">ver rol</a>
                    
                   
                    <a href="{{ route('roles.edit', $role->id) }}" class="p-2 bg-green-300">editar rol</a>
...
<!-- <div class="mt-10">
    <a href="{{ route('roles.create') }}" class="p-2 bg-green-300">Añadir rol</a>
</div> -->
@if(@Auth::user()->hasRole('spadmin'))
    @section('btn-crear-convocatoria')
    <div class="p-1 rounded-lg bg-yellow-600 hover:bg-yellow-700">
        <a href="{{ route('roles.create') }}" class=" flex text-white ">Añadir roles

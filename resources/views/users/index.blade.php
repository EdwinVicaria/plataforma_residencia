...
<div>
    @section('btn-crear-usuario')
    <div class="p-1 rounded-lg bg-yellow-600 hover:bg-yellow-700">
        <a href="{{ route('users.create') }}" class=" flex text-white ">Añadir usuario
    ...
    <div>
        @if(session('success'))
         <div role="success">{{session('success')}}</div>
        @endif
    </div>
                ...
                <tr class="bg-white border-b border-gray-700">
                    ...
                    <td class="py-4 px-6 flex">
                        ...
                        <form action="{{ route('users.delete', $user->id) }}" method="post"
                            style="display: inline-block;" onsubmit="return confirm('Seguro quieres eliminar el usuario?, no se podra recuperar despues')">
